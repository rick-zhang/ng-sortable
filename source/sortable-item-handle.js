                ...
                link: function (scope, element, attrs, itemController) {
                    ...
                    createPlaceholder = function (itemScope) {
                        if (typeof scope.sortableScope.options.placeholder === 'function') {
                            ...
                            var placeHolder = angular.element($document[0].createElement(itemScope.element.prop('tagName')));

                            //Rick: if sortable item is table row
                            // 1. add 'table-row' display style to fix position issue
                    ...
                    function insertBefore(targetElement, targetScope) {
                        ...
                        //Rick: specify 'TR' to check if sortable item is a table row
                        if (placeHolder.prop('tagName') == 'TR') {
                            placeHolder.css({display: 'table-row'});
                        } else {
